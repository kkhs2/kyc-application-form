...
const submitFormButton = [...document.getElementsByTagName("next-button")];
...
let bottomlineReason = attributeFinder(
      ...
      let bottomlineName = attributeFinder(
        inputs,
        "data-name",
        "BottomlineName",
      );
...
chosenTradingStyle.addEventListener("change", () => {
  ...
  if (
    ...
    confirmAccountHolderUrl.href = path.includes("credit-increase")
